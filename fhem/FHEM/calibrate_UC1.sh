...
#                Rueckgabe an FHEM
# --------------------------------------------------------
os.system('perl /opt/fhem/fhem.pl 7072 "setreading UC1 Kalibrierung 0"')
...
if float(distanceRet) <= 400:
  os.system('perl /opt/fhem/fhem.pl 7072 "setreading UC1 Kalibrierung '+str(distanceRet)+'"')
os.system('perl /opt/fhem/fhem.pl 7072 "set calibrate_UC1 off"')
GPIO.cleanup()